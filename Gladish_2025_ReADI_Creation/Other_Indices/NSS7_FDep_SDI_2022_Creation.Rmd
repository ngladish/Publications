...
```{r, eval = F}
NA_ADI_CBG_2022 <- read.csv("https://raw.githubusercontent.com/ngladish/Publications/main/Gladish_2025_ReADI_Creation/Other Indices/SVI_2022_US_county.csv", colClasses = c(FIPS = "character"), stringsAsFactors = FALSE)
